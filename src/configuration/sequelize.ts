...
try {
    ...
    console.log("Connection " + (error as Error).message);
}
...
db.user_model = require('../model/user_model').default(connection, Sequelize)
db.address_model = require('../model/address_model').default(connection, Sequelize)

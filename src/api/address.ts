...
router.get("/getAddressBookByID/:user_id", async (req: any, res: any) => {
    try {
...
router.post('/createAddressBook', async (req: any, res: any) => {
    try {
        // Object destructure
...
router.put("/updateAddressBook/:userid/:addressid", async (req: any, res: any) => {
    try {
        var date = datetime.getFullYear() + "/" + datetime.getMonth() + "/" + datetime.getDate();
...
router.delete("/removeAddressBook/:userid/:addressid", async (req: any, res: any) => {
    try {
